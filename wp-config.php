...
// from dokku instructions and some articles
...
// from official wp instructions
// sometimes can show an warning
if (strpos($_SERVER['HTTP_X_FORWARDED_PROTO'], 'https') !== false)
$_SERVER['HTTPS']='on';

// not so useful
define('FORCE_SSL_ADMIN', (bool)fromenv('FORCE_SSL_ADMIN', false));

// if wp served from subdirectory
